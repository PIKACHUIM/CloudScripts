...
# Init -------------------------------------------------------
cat > /usr/share/X11/xorg.conf.d/xorg.conf <<'EOF'
...
Section "Screen"
  ...
  SubSection "Display"
    ...
    Modes "1920x1080" "1600x1200" "1680x1050" "1600x900" "1400x1050" "1440x900" "1280x1024" "1366x768" "1280x800" "1024x768" "1024x600" "800x600" "320x200"
    #Virtual 32000 32000
    #Virtual 16384 8192
#    Virtual 8192 4096
    #Virtual 5120 3200
