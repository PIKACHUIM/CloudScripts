...
main_download() {
    ...
    CommonMediaTests)
        ...
        ;;
    media_lmc_check)
        local url="https://benchs.pika.net.cn/ecss-bench/check.sh"
    ...
    portchecker)
        ...
        ;;
    yabs)
        local url="https://benchs.pika.net.cn/ecss-bench/yabs_github.sh"
        ...
        ;;
    ecsspeed_ping)
        local url="https://benchs.pika.net.cn/ecss-bench/ecsspeed-ping_github.sh"
...
download_speedtest_file() {
    ...
    local url3="https://benchs.pika.net.cn/ecss-bench/speedtest-go_${Speedtest_Go_version}_Linux_${sys_bit_go}_github.tar.gz"
...
comprehensive_test_script_options() {
    case $StartInputc in
    1)
        wget -qO- --no-check-certificate https://benchs.pika.net.cn/superbench/superbench.sh | bash
        break_status=true
        ;;
    2)
    ...
    5)
        ...
        ;;
    6)
        wget --no-check-certificate https://benchs.pika.net.cn/unix-bench/unixbench.sh && chmod +x unixbench.sh && ./unixbench.sh
        break_status=true
        ;;
    7)
