...
pre_download() {
    ...
    Linux)
        ...
        "x86_64" | "x86" | "amd64" | "x64")
            wget -O securityCheck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/securityCheck-linux-amd64"
            wget -O pck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/portchecker-linux-amd64"
            ;;
        "i386" | "i686")
            wget -O securityCheck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/securityCheck-linux-386"
            wget -O pck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/portchecker-linux-386"
            ;;
        "armv7l" | "armv8" | "armv8l" | "aarch64")
            wget -O securityCheck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/securityCheck-linux-arm64"
            wget -O pck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/portchecker-linux-arm64"
            ;;
        *)
    ...
    Darwin)
        case $arch in
        "x86_64" | "x86" | "amd64" | "x64")
            wget -O securityCheck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/securityCheck-darwin-amd64"
            wget -O pck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/portchecker-darwin-amd64"
            ;;
        "i386" | "i686")
            wget -O securityCheck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/securityCheck-darwin-386"
            wget -O pck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/portchecker-darwin-386"
            ;;
        "armv7l" | "armv8" | "armv8l" | "aarch64")
            wget -O securityCheck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/securityCheck-darwin-arm64"
            wget -O pck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/portchecker-darwin-arm64"
            ;;
        *)
            echo "Unsupported architecture: $arch"
            exit 1
    ...
    FreeBSD)
        case $arch in
        amd64)
            wget -O securityCheck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/securityCheck-freebsd-amd64"
            wget -O pck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/portchecker-freebsd-amd64"
            ;;
        "i386" | "i686")
            wget -O securityCheck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/securityCheck-freebsd-386"
            wget -O pck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/portchecker-freebsd-386"
            ;;
        "armv7l" | "armv8" | "armv8l" | "aarch64")
            wget -O securityCheck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/securityCheck-freebsd-arm64"
            wget -O pck "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/portchecker-freebsd-arm64"
            ;;
        *)
            echo "Unsupported architecture: $arch"
            exit 1
