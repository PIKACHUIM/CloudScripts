...
if  [ ! -e '/tmp/besttrace' ]; then
    ...
    dir=$(pwd)
    cd /tmp/
    wget  -N --no-check-certificate https://benchs.pika.net.cn/ecss-bench/besttrace > /dev/null 2>&1
    cd $dir
fi
...
if  [ ! -e '/tmp/speedtest.py' ]; then
    ...
    dir=$(pwd)
    cd /tmp/
    wget -N --no-check-certificate https://benchs.pika.net.cn/ecss-bench/speedtest.py > /dev/null 2>&1
    cd $dir
fi
...
if  [ ! -e '/tmp/ZPing-CN.py' ]; then
    ...
    dir=$(pwd)
    cd /tmp/
    wget -N --no-check-certificate https://benchs.pika.net.cn/ecss-bench/ZPing-CN.py > /dev/null 2>&1
    cd $dir
fi
...
wget -N --no-check-certificate https://benchs.pika.net.cn/ecss-bench/Generate.py >> /dev/null 2>&1
