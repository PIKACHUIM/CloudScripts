...
rawgithub="https://benchs.pika.net.cn/ip-quality/"
return 0
else
rawgithub="https://benchs.pika.net.cn/ip-quality/"
return 1
...
while :;do
local content
content=$(curl -fsL --max-time 5 "${rawgithub}ref/ad$i.ans")||break
ads+=("$content")
((i++))
done
local adCount=${#ads[@]}
...
local -a aad
aad[0]=$(curl -sL --max-time 5 "${rawgithub}ref/sponsor.ans")
