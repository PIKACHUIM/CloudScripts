...
install_speedtest() {
    if [ ! -e "./speedtest-cli/speedtest" ]; then
        ...
        url1="https://benchs.pika.net.cn/qsyb-bench/ookla-speedtest-1.2.0-linux-${sys_bit}.tgz"
        url2="https://benchs.pika.net.cn/qsyb-bench/ookla-speedtest-1.2.0-linux-${sys_bit}.tgz"
