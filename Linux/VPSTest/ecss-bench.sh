...
checkver() {
    ...
    curl -L "${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/ecs.sh" -o ecs1.sh || curl -L "https://benchs.pika.net.cn/ecss-bench/ecs.sh" -o ecs1.sh
    chmod 777 ecs1.sh
...
checkpip() {
    [ "${Var_OSRelease}" = "freebsd" ] && curl -L https://benchs.pika.net.cn/ecss-bench/get-pip.py -o get-pip.py && chmod +x get-pip.py && python3 get-pip.py && rm -rf get-pip.py && return
    local pvr="$1"
...
main_download() {
    ...
    case $file in
    sysbench)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/sysbench.zip"
        ...
        ;;
    CommonMediaTests)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/${CommonMediaTests_FILE}"
        ...
        ;;
    media_lmc_check)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/media_lmc_check.sh"
        ...
        ;;
    nexttrace)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/${NEXTTRACE_FILE}"
        ...
        ;;
    backtrace)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/$BACKTRACE_FILE"
        local output="$TEMP_DIR/backtrace"
        download_file "$url" "$output" "$PROGRESS_DIR/$file"
        echo "100" >"$PROGRESS_DIR/$file"
        ;;
    gostun)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/$GOSTUN_FILE"
        local output="$TEMP_DIR/gostun"
        download_file "$url" "$output" "$PROGRESS_DIR/$file"
        echo "100" >"$PROGRESS_DIR/$file"
        ;;
    securityCheck)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/$SecurityCheck_FILE"
        local output="$TEMP_DIR/securityCheck"
        download_file "$url" "$output" "$PROGRESS_DIR/$file"
        echo "100" >"$PROGRESS_DIR/$file"
        ;;
    portchecker)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/$PortChecker_FILE"
        local output="$TEMP_DIR/pck"
        download_file "$url" "$output" "$PROGRESS_DIR/$file"
        echo "100" >"$PROGRESS_DIR/$file"
        ;;
    yabs)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/yabs.sh"
        ...
        ;;
    ecsspeed_ping)
        local url="${cdn_success_url}https://benchs.pika.net.cn/ecss-bench/ecsspeed-ping.sh"
...
check_cdn_file() {
    check_cdn "https://benchs.pika.net.cn/ecss-bench/test"
...
download_speedtest_file() {
    ...
    local url3="https://benchs.pika.net.cn/ecss-bench/speedtest-go_${Speedtest_Go_version}_Linux_${sys_bit_go}.tar.gz"
    if [[ -z "${CN}" || "${CN}" != true ]]; then
        ...
        if [ "$speedtest_ver" = "1.2.0" ]; then
            local url1="https://benchs.pika.net.cn/ecss-bench/ookla-speedtest-1.2.0-linux-${sys_bit}.tgz"
            local url2="https://benchs.pika.net.cn/ecss-bench/ookla-speedtest-1.2.0-linux-${sys_bit}.tgz"
        else
            local url1="https://benchs.pika.net.cn/ecss-bench/ookla-speedtest-1.0.0-${sys_bit}-linux.tgz"
            local url2="https://benchs.pika.net.cn/ecss-bench/ookla-speedtest-1.0.0-${sys_bit}-linux.tgz"
        fi
...
speedtest_ver="1.2.0"
SERVER_BASE_URL="https://benchs.pika.net.cn/ecss-bench/speedtest.net-CN-ID"
SERVER_BASE_URL2="https://benchs.pika.net.cn/ecss-bench/speedtest.cn-CN-ID"
...
comprehensive_test_script_options() {
    case $StartInputc in
    1)
        wget -qO- --no-check-certificate https://benchs.pika.net.cn/ecss-bench/superbench.sh | bash
        break_status=true
        ;;
    2)
    ...
    5)
        ...
        ;;
    6)
        wget --no-check-certificate https://benchs.pika.net.cn/ecss-bench/unixbench.sh && chmod +x unixbench.sh && ./unixbench.sh
        break_status=true
        ;;
    7)
        wget -N --no-check-certificate https://benchs.pika.net.cn/ecss-bench/ZBench-CN.sh && bash ZBench-CN.sh
        break_status=true
        ;;
    0)
        original_script
...
media_test_script_options() {
    case $StartInputm in
    1)
        wget -O nf https://benchs.pika.net.cn/ecss-bench/nf_linux_amd64 && chmod +x nf && ./nf
        break_status=true
        ;;
    2)
        wget -O tubecheck https://benchs.pika.net.cn/ecss-bench/tubecheck_1.0beta_linux_amd64 && chmod +x tubecheck && clear && ./tubecheck
        break_status=true
        ;;
    3)
        wget -O dp https://benchs.pika.net.cn/ecss-bench/dp_1.01_linux_amd64 && chmod +x dp && clear && ./dp
        break_status=true
        ;;
    4)
        lmc999_script
        ...
        ;;
    5)
        bash <(curl -s https://benchs.pika.net.cn/ecss-bench/tiktok.sh)
        break_status=true
        ;;
    6)
...
network_test_script_options() {
    case $StartInputn in
    1)
        curl https://benchs.pika.net.cn/ecss-bench/backtrace_install.sh -sSf | sh
        break_status=true
        ;;
    2)
        curl https://benchs.pika.net.cn/ecss-bench/mtr_trace.sh | bash
        break_status=true
        ;;
    3)
        ...
        ;;
    4)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/return.sh)
        break_status=true
        ;;
    5)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/nexttrace.sh)
        break_status=true
        ;;
    6)
        # wget -O jcnf.sh https://benchs.pika.net.cn/ecss-bench/jcnf.sh && bash jcnf.sh
        echo "jcnf.sh script is not available"
        break_status=true
        ;;
    7)
...
hardware_test_script_options() {
    case $StartInputh in
    1)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/disk_info.sh)
        break_status=true
        ;;
    2)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/geekbench4.sh)
        break_status=true
        ;;
    3)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/geekbench5.sh)
        break_status=true
        ;;
    4)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/geekbench6.sh)
        break_status=true
        ;;
    5)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/multi_disk_io_test.sh)
        break_status=true
        ;;
    0)
        original_script
...
single_item_script_options() {
    ...
    4)
        ...
        bash <(wget -qO- --no-check-certificate https://benchs.pika.net.cn/ecss-bench/ipcheck.sh)
        break_status=true
        ;;
    5)
        port_script
...
my_original_script_options() {
    ...
    7)
        ...
        ;;
    8)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/customizeqzcheck.sh)
        break_status=true
        ;;
    9)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/disk_info.sh)
    ...
    16)
        ...
        ;;
    17)
        bash <(curl -sSL https://benchs.pika.net.cn/ecss-bench/gostun_install.sh)
        break_status=true
        ;;
    0)
        start_script
