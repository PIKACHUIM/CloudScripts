...
function BenchAPI_DepProcess_DepInst_JsonQuery() {
    ...
    curl -o /tmp/jq.tar.gz https://benchs.pika.net.cn/lemonbench/jq-1.6-"$(arch)".tar.gz
...
function BenchAPI_DepProcess_DepInst_FIO() {
    [[ "${Flag_DepProcess_DepScan_CurlExist}" != "1" ]] && BenchAPI_DepProcess_DepInst_Curl
    curl -o /tmp/fio.tar.gz https://benchs.pika.net.cn/lemonbench/fio-3.34-"$(arch)".tar.gz
    pushd /tmp/ >/dev/null 2>&1 || return 1
...
function BenchAPI_DepProcess_DepInst_Speedtest() {
    [[ "${Flag_DepProcess_DepScan_CurlExist}" != "1" ]] && BenchAPI_DepProcess_DepInst_Curl
    curl -o /tmp/speedtest.tar.gz https://benchs.pika.net.cn/lemonbench/speedtest-1.2.0-"$(arch)".tar.gz
    pushd /tmp/ >/dev/null 2>&1 || return 1
...
function BenchAPI_DepProcess_DepInst_NextTrace() {
    [[ "${Flag_DepProcess_DepScan_CurlExist}" != "1" ]] && BenchAPI_DepProcess_DepInst_Curl
    curl -o /tmp/nexttrace.tar.gz https://benchs.pika.net.cn/lemonbench/nexttrace-1.3.5-"$(arch)".tar.gz
    pushd /tmp/ >/dev/null 2>&1 || return 1
...
function BenchAPI_DepProcess_DepInst_WorstTrace() {
    [[ "${Flag_DepProcess_DepScan_CurlExist}" != "1" ]] && BenchAPI_DepProcess_DepInst_Curl
    curl -o /tmp/worsttrace.tar.gz https://benchs.pika.net.cn/lemonbench/worsttrace-2.0.7-"$(arch)".tar.gz
    pushd /tmp/ >/dev/null 2>&1 || return 1
